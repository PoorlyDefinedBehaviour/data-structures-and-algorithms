...
class BinarySearchTree {
  ...
  private function assert_not_empty(): void {
    if($this->is_empty()) throw new Exception("Tried to perform an operation which requires a non empty tree");
  }
  ...
  public function insert($value): BinarySearchTree {
    ...
    while($current_node){
      if($this->is_equal($value, $current_node->data)) return $this;
  ...
  public function remove($value): BinarySearchTree {
    ...
    if(!$node_to_delete_parent && !$node_to_delete) return $this;
